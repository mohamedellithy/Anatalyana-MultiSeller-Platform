                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @if(Module::isModuleEnabled('Agencies'))
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('admin.seller-agencies') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller_packages.index', 'seller_packages.create', 'seller_packages.edit'])}}">
                                        <span class="aiz-side-nav-text">{{ translate('Seller Agencies') }}</span>
                                    </a>
                                </li>
                            @endif
                        </ul>
