            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @if(Module::isModuleEnabled('Agencies'))
                    <li class="aiz-side-nav-item">
                        <a href="javascript:void(0);" class="aiz-side-nav-link">
                            <i class="las la-gavel aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Agencies') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('seller.agencies') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['seller.agencies']) }}">
                                    <span
                                        class="aiz-side-nav-text">{{ translate('All Agencies') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('seller.agents-show') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['seller.agents-show']) }}">
                                    <span
                                        class="aiz-side-nav-text">{{ translate('Agents') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
