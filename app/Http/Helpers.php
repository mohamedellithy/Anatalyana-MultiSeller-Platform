...
// here added after added agencies module
if (!function_exists('get_from_translations')) {
    function get_from_translations($object,$lang = null,$field = null)
    {
        $lang = $lang == null ? \App::getLocale() : $lang;
        $translation     = collect($object)->where('lang',$lang)->first();
        if(!$translation):
            $translation = collect($object)->where('lang',env('DEFAULT_LANGUAGE'))->first();
        endif;

        return $field == null ? $translation : $translation->$field;
    }
}
