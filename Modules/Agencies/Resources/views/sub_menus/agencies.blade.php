    ...
    <div class="content-sub-menu d-flex">
        <ul class="">
            <li class="sub_menu_titles">
                <a class="icon-menu-topbar mb-0 {{ areActiveRoutes(['seller.agencies','seller.agency-info']) }}" href="{{  route('seller.agencies') }}">
            ...
            <li class="sub_menu_titles">
                <a class="icon-menu-topbar mb-0 {{ areActiveRoutes(['seller.agents-show']) }}" href="{{ route('seller.agents-show') }}">
                    <label class="fs-14  fw-400 mb-0">
