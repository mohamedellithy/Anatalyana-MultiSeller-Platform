...
@section('panel_content')
    ...
    <div class="aiz-titlebar mt-2 mb-4">
      <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="h3">{{ translate('Booking Meets') }}</h1>
        </div>
      </div>
    </div>
    <div class="card-body">
        ...
        <form class="" id="sort_sellers" action="" method="GET">
            <div class="card-header row gutters-5">
                ...
                <div class="col-md-2 ml-auto">
                    <select class="form-control aiz-selectpicker" name="date_status" id="approved_status" onchange="sort_sellers()">
                        <option value="">{{translate('Fetch By Date')}}</option>
                        <option value="today"      @isset($sort_date_status) @if($sort_date_status == 'today')      selected @endif @endisset>{{translate('today')}}</option>
                        <option value="this_week"  @isset($sort_date_status) @if($sort_date_status == 'this_week')  selected @endif @endisset>{{translate('this week')}}</option>
                        <option value="this_month" @isset($sort_date_status) @if($sort_date_status == 'this_month') selected @endif @endisset>{{translate('this Month')}}</option>
                        <option value="this_year"  @isset($sort_date_status) @if($sort_date_status == 'this_year')  selected @endif @endisset>{{translate('this year')}}</option>
                    </select>
                </div>
                <div class="col-md-2 ml-auto">
